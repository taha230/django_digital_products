...
```
django_digital_products/
├── manage.py
├── requirements.txt
├── README.md
├── .gitignore
│
├── django_digital_products/          # Project config
│   ├── __init__.py
│   ├── settings.py
│   ├── urls.py
│   ├── asgi.py
...
│   ├── models.py                     # User, UserProfile, Device, Province
│   ├── views.py
│   ├── urls.py
│   ├── admin.py
│   ├── apps.py
...
│   └── migrations/
│
├── products/                         # Catalog: categories, products, files
│   ├── models.py                     # Category, Product, File
│   ├── views.py
│   ├── serializers.py
│   ├── urls.py
│   ├── admin.py
...
│   └── migrations/
│
├── subscriptions/                    # Packages & user subscriptions
│   ├── models.py                     # Package, Subscription
│   ├── views.py
│   ├── serializers.py
│   ├── urls.py
│   ├── admin.py
...
└── utils/                            # Shared helpers
    └── validators.py                 # validate_sku, validate_phone_number, etc.
```
